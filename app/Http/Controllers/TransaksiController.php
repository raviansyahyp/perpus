        ...
        */
               ...
               if(Anggota::where('id_anggota', $request->id_anggota)->count() > 0){
                    if(Buku::where('id_buku', $request->id_buku)->count() > 0){
                         ...
                         if($request->type_transaksi == 'pinjam'){
                              ...
                              $transaksi->tgl_kembali = $request->tgl_kembali; //null;
                              $transaksi->save();
          ...
          */
          ...
          public function show($id)
          {
               ...
               'table_transaksi.tgl_kembali') ->where('table_transaksi.id', '=', $id)->first();
          ...
          public function showBuku($id)
          {
               ...
               if(Buku::where('id_buku', $id)->count() > 0){
                    ...
                    ->where('table_buku.id_buku', '=', $id)->get();
          ...
          public function getAnggota($id)
          {
                ...
                //return redirect('transaksi/create', compact('anggota'));
